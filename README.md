...
**Full-Stack Developer** currently developing skills in **Cloud Computing** and **Software Architecture**. I possess skills in **Numerical Optimization**, **Probability** and **Statistics**. So, I am learning **Machine Learning** and **Big Data** tools for production. These technologies are changing many aspects of our lives, and I try to  **re-invent** a **better world** with better opportunities for all.
